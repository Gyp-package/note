![image-20230719094403680](C:\Users\ChiShuiguo\AppData\Roaming\Typora\typora-user-images\image-20230719094403680.png)
...
​    return 0;
  ...
  const left = new Array(m).fill(0).map(() => new Array(n).fill(0));//初始化每一行每一列元素为0
